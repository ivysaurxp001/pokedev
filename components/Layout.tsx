...
const Layout: React.FC<LayoutProps> = ({ children, onNavigate, currentView }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 flex flex-col md:flex-row relative md:overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex-1 md:overflow-y-auto min-h-screen md:h-screen relative z-10 scroll-smooth pt-16 md:pt-0">
