  ...
  return (
    <>
      <div className="space-y-8">
        ...
        {/* Featured Projects */}
        {sortedProjects.some(p => p.is_featured) && (
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="text-amber-500">★</div>
              <h2 className="text-lg font-tech font-bold text-white">Featured Projects</h2>
              <div className="flex-1 h-px bg-gradient-to-r from-amber-500/50 to-transparent"></div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedProjects.filter(p => p.is_featured).map((project, idx) => (
                <div key={project.id} className="relative">
                  <div className="absolute -top-2 -left-2 w-6 h-6 bg-amber-500 flex items-center justify-center z-10 shadow-lg">
        ...
        {/* All Projects Grid */}
        {sortedProjects.filter(p => !p.is_featured).length > 0 && (
          <div className="space-y-4">
            {sortedProjects.some(p => p.is_featured) && (
              <div className="flex items-center gap-3">
                <h2 className="text-lg font-tech font-bold text-white">All Projects</h2>
